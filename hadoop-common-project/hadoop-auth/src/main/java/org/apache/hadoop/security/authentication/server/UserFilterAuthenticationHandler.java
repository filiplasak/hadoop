...
/**
 * The <code>UserFilterAuthenticationHandler</code> provides a pseudo authentication mechanism that accepts
 * the user name specified as a query string parameter and allow only those that are specified in configuration.
 * <p>
 ...
 * <ul>
 * <li>user.filter.anonymous.allowed: <code>true|false</code>, default value is <code>false</code></li>
 * <li>user.filter.allowed.username: <code>username</code>, default value is <code>null</code></li></li>
 * </ul>
 */
public class UserFilterAuthenticationHandler implements AuthenticationHandler {

  private static Logger LOG = LoggerFactory.getLogger(UserFilterAuthenticationHandler.class);

  /**
   * Constant that identifies the authentication mechanism.
   */
  public static final String TYPE = "user.filter";
  ...
  /**
   * Constant for the configuration property that indicates which username is allowed to log in.
   */
  public static final String ALLOWED_USERNAME = TYPE + ".allowed.username";
   ...
   */
  public UserFilterAuthenticationHandler() {
    this(TYPE);
  }
   ...
   */
  public UserFilterAuthenticationHandler(String type) {
    this.type = type;
  }
  ...
  public void init(Properties config) throws ServletException {
    ...
    allowedUsername = config.getProperty(ALLOWED_USERNAME, "null");
  }
  ...
  /**
   * Returns allowed username.
   *
   * @return allowed username.
   */
  protected String getAllowedUsername() {
  ...
  public AuthenticationToken authenticate(HttpServletRequest request, HttpServletResponse response)
    ...
    LOG.debug("userName: " + userName + " getAllowedUsername(): " + getAllowedUsername());

    if (userName == null || !userName.equals(getAllowedUsername())) {
